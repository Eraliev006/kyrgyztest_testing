...
namespace KyrgyzTest.Infrastructure.Migrations
{
    ...
    [Migration("20260515161656_AddCandidatePhoto")]
            ...
            modelBuilder.Entity("KyrgyzTest.Core.Entities.Users", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 5, 15, 16, 16, 55, 744, DateTimeKind.Utc).AddTicks(3330),
                            FullName = "Super Admin",
                            Login = "superadmin",
                            PasswordHash = "$2a$11$J1novLhoDgpmwy78C2eWfeY7wUHTTj8CWEhgtsDG8pEkScyo/0CRS",
                            Role = 0
                        });
                });
